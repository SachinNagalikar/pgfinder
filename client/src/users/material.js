               ...
               <Paper className={classes.paper}>
                   ...
                   <form className={classes.form} onSubmit={this.handleSubmit}>
                       ...
                       <FormControl margin="normal" required fullWidth>
                           ...
                           <Input id="middlename" name="middlename" autoComplete="middlename" value={this.state.middleName} onChange={this.handleMiddle} autoFocus />
                           <FormText color="danger">{this.state.middleNameError}</FormText>
                       </FormControl>
                       <FormControl margin="normal" required fullWidth>
                           <InputLabel htmlFor="lastname">Last name</InputLabel>
                           <Input id="lastname" name="lastname" autoComplete="lastname" value={this.state.lastName} onChange={this.handleLast} autoFocus />
                           <FormText color="danger">{this.state.firstNameError}</FormText>
                       </FormControl>
                       <FormControl margin="normal" required fullWidth>
